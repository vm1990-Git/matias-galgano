    ...
    >
      ...
      <div className="flex justify-center flex-col gap-5 xl:grid xl:grid-cols-2 md:self-center md:items-start p-4">
        ...
        <QuestionaryItem
          ...
          answer="En general debe realizarse un control anual, sobre todo si existen antecedentes de patologías oftalmológicas como el glaucoma en los familiares o si están operados de los ojos, pero dentro de los síntomas que deben alertar al paciente para concurrir están: Mala visión, dolores de cabeza, entre otros."
        />
        <QuestionaryItem
        ...
        <QuestionaryItem
          ...
          answer="No hay preparación, solo debe concurrir preferentemente acompañado, con lentes de Sol y sin conducir ya que se verá afectada la visión de lejos y cerca."
        />
        <QuestionaryItem
          question="¿Hacés cirugías de catarata y refractivas?"
          answer="Luego de una evaluación completa con fondo de ojos, toma de presión y los estudios que correspondiere."
        />
      </div>
    </div>
  );
