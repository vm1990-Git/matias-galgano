    ...
    >
      ...
      <div className="flex justify-center flex-col gap-5 xl:grid xl:grid-cols-2 md:self-center md:items-start p-4">
        <QuestionaryItem
          ...
          answer="Traé cualquier resumen de historia clínica disponible, estudios previos. Si la consulta es por fondo de ojos, te recomiendamos asistir acompañado."
        />
        <QuestionaryItem
        ...
        <QuestionaryItem
          ...
          answer="Si, podés estar en cualquier parte del mundo. Utilizamos plataformas como Zoom y Teams, con estándares de confidencialidad y calidad en la atención, incluso en el entorno virtual. Tu privacidad y bienestar son nuestra prioridad, sin importar la modalidad de consulta que elijas."
        />
        <QuestionaryItem
          question="¿Cuáles son los síntomas para consultar a un oftalmólogo?"
          answer="En general, se debe realizar un control anual, sobre todo si existen antecedentes de patologías oftalmológicas como el glaucoma, o antecedentes de cirugías oftalmológicas."
        />
        <QuestionaryItem
        ...
        <QuestionaryItem
          ...
          answer="No hay preparación. Hay concurrir preferentemente acompañado, con lentes de Sol y sin conducir ya que se verá afectada la visión, sobre todo de cerca."
        />
        <QuestionaryItem
